...
- [X] [ABC: Always Be Coding](https://medium.com/always-be-coding/abc-always-be-coding-d5f8051afce2#.4heg8zvm4)
    * From the article, find out if this guide covers these *  
    - Code at least something once a day. It's not about time it's about quality of work.
	- Master Python
	- Big O notation needs to be explored
	- Reinvent the wheel(build them data structures) 
	- Practice using word problems
	- Have fun with it (nothing is impossible we can figure it out)

- [X] [Whiteboarding](https://medium.com/@dpup/whiteboarding-4df873dbba2e#.hf6jn45g1)
	* Reread this before interviewing *
